...
class Training(GenericWorkflow):
    ...
    def __init__(self, model, data_loader, losses, optimizer, metrics=None,  batch_schedule=False, scheduler=None, gpu=True):
        """
...
class TrainingApexAMP(Training):
    ...
    def __init__(self, model, data_loader, losses, optimizer, metrics=None, batch_schedule=False, scheduler=None, opt_level="O1"):
        """
        :param model: The model to be used for training. This model instance will be optimized by the Training module.
        :type model: torch.nn.Module
        :param data_loader: A DataLoader instance which handles the data loading and batching
        ...
        """
        super(TrainingApexAMP, self).__init__(model, data_loader, losses, optimizer, metrics, batch_schedule, scheduler, gpu=True)
...
class TrainingAMP(Training):
    ...
    def __init__(self, model, data_loader, losses, optimizer, metrics=None, batch_schedule=False, scheduler=None):
        """
        :param model: The model to be used for training. This model instance will be optimized by the Training module.
        :type model: torch.nn.Module
        :param data_loader: A DataLoader instance which handles the data loading and batching
        ...
        """
        super(TrainingAMP, self).__init__(model, data_loader, losses, optimizer, metrics, batch_schedule, scheduler, gpu=True)
